...
public class AppBlockSpawnController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // CreateSubcategoriesList(Product.Categories.Game);
        // SpawnBlocks();
    ...
    /*
    public void SpawnBlocks(Products products)
    {
        ...
        for (int i = 0; i < products.AllProducts.Count; i++)
        {
            ...
            appBlockController.Initialize(products.AllProducts[i]);
    ...
    */
    ...
    {   
        for (int i = 0; i < _subCategoriesToSpawn.Count; i++)
        {
            GameObject spawnedBlock = Instantiate(CategoryBlockPrefab, Content);
            CategoryBlockController categoryBlockController = spawnedBlock.GetComponent<CategoryBlockController>();
            categoryBlockController.Initialize(_subCategoriesToSpawn[i],"Description");
